...
function IntroAnimation({ onComplete }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "IntroAnimation.useEffect": ()=>{
            ...
            }["IntroAnimation.useEffect"], 800)); // Phase 2 at 0.8s
            timers.push(setTimeout({
                "IntroAnimation.useEffect": ()=>setPhase('logo')
            }["IntroAnimation.useEffect"], 2200)); // Phase 3 at 2.2s
            timers.push(setTimeout({
                "IntroAnimation.useEffect": ()=>setPhase('subtitle')
            }["IntroAnimation.useEffect"], 3200)); // Phase 4 at 3.2s
            timers.push(setTimeout({
                "IntroAnimation.useEffect": ()=>setPhase('hold')
            }["IntroAnimation.useEffect"], 4400)); // Phase 5 at 4.4s — breathe
            timers.push(setTimeout({
                "IntroAnimation.useEffect": ()=>setPhase('pulse')
            }["IntroAnimation.useEffect"], 5200)); // Phase 6 at 5.2s — explosion
            timers.push(setTimeout({
                "IntroAnimation.useEffect": ()=>setPhase('fade')
            }["IntroAnimation.useEffect"], 6000)); // Phase 7 at 6.0s — fade out
            timers.push(setTimeout({
                "IntroAnimation.useEffect": ()=>{
                    setPhase('done');
                    onCompleteStable();
                }
            }["IntroAnimation.useEffect"], 7000)); // Complete at 7s
            return ({
    ...
    const geoLines = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "IntroAnimation.useMemo[geoLines]": ()=>Array.from({
                length: 8
            }).map({
                "IntroAnimation.useMemo[geoLines]": (_, i)=>({
            ...
            }["IntroAnimation.useMemo[geoLines]"])
    }["IntroAnimation.useMemo[geoLines]"], []);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            isHold && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            (phase === 'logo' || phase === 'subtitle' || phase === 'hold') && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            isHold && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    geoLines.map((line, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "absolute",
                            style: {
                                left: `${line.startX}%`,
                                top: `${line.startY}%`,
...
_s(IntroAnimation, "Oun8VWLtO4UHaaINrVifqi8gqvo=");
_c = IntroAnimation;
var _c;
